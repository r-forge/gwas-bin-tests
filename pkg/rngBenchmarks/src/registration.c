...
/*void R_init_rngBenchmarks(DllInfo *info)
{
    initializeRngArray = (void (*) (int)) R_GetCCallable("rngBenchmarks", "initializeRngArray");
    getRngDouble = (double (*) (int)) R_GetCCallable("rngBenchmarks", "getRngDouble");
    destroyRngArray = (void (*) ()) R_GetCCallable("rngBenchmarks", "destroyRngArray");
}
